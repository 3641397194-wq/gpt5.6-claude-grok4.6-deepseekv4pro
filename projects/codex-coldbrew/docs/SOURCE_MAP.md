...
|---|---|---|---|
| [`3641397194-wq/codex5.6-coldbrew@d628641`](https://github.com/3641397194-wq/codex5.6-coldbrew/commit/d628641c9d401e8f8e7ebaf362faa0891afd9362) | ColdBrew project license | seven routes, MAX overlays, 17-domain/181-node catalog, install and rollback contracts | retained project-owned `skills/eni-coldbrew/` baseline, migrated to v5 contracts |
